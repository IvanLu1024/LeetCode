...
​	=SUM(F(i-1)*F(n-i)),i=1...n

> 来源于： https://leetcode-cn.com/problems/two-sum/solution/hua-jie-suan-fa-96-bu-tong-de-er-cha-sou-suo-shu-b/
...
用一个for循环遍历以分别1到n每个节点为根节点的二叉搜索树
